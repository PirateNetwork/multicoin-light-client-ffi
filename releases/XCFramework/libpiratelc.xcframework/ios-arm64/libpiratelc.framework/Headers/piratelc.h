...
int32_t piratelc_clear_utxos(const uint8_t *db_data,
 ...
 */
char *piratelc_derive_extended_full_viewing_key(const char *extsk, uint32_t network_id);
 ...
 */
char **piratelc_derive_extended_full_viewing_keys(const uint8_t *seed,
                                                  uintptr_t seed_len,
                                                  int32_t accounts,
 ...
 * Call `piratelc_vec_string_free` on the returned pointer when you are finished with it.
 */
char **piratelc_derive_extended_spending_keys(const uint8_t *seed,
                                              uintptr_t seed_len,
                                              int32_t accounts,
                                              uintptr_t *capacity_ret,
                                              uint32_t network_id);
 ...
 * call piratelc_string_free with the returned pointer when done using it
 */
char *piratelc_derive_shielded_address_from_seed(const uint8_t *seed,
                                                 uintptr_t seed_len,
 ...
 * call piratelc_string_free with the returned pointer when done using it
 */
char *piratelc_derive_shielded_address_from_viewing_key(const char *extfvk, uint32_t network_id);

/**
 * derives a shielded address from the given viewing key.
 * call piratelc_string_free with the returned pointer when done using it
 */
char *piratelc_derive_transparent_address_from_public_key(const char *pubkey, uint32_t network_id);

/**
 * Derives a transparent address from the given secret key enconded as a WIF string
 */
char *piratelc_derive_transparent_address_from_secret_key(const char *tsk, uint32_t network_id);

/**
 * Derives a transparent address from the given seed
 */
char *piratelc_derive_transparent_address_from_seed(const uint8_t *seed,
                                                    uintptr_t seed_len,
                                                    int32_t account,
                                                    int32_t index,
                                                    uint32_t network_id);
 ...
 */
char *piratelc_derive_transparent_private_key_from_seed(const uint8_t *seed,
                                                        uintptr_t seed_len,
                                                        int32_t account,
                                                        int32_t index,
                                                        uint32_t network_id);

FFIUVKBoxedSlice *piratelc_derive_unified_viewing_keys_from_seed(const uint8_t *seed,
                                                                 uintptr_t seed_len,
                                                                 int32_t accounts,
                                                                 uint32_t network_id);
...
void piratelc_free_uvk_array(FFIUVKBoxedSlice *uvks);
 ...
 */
char *piratelc_get_address(const uint8_t *db_data,
                           uintptr_t db_data_len,
                           int32_t account,
                           uint32_t network_id);
 ...
 * Call `piratelc_vec_string_free` on the returned pointer when you are finished with it.
 */
char **piratelc_init_accounts_table(const uint8_t *db_data,
                                    uintptr_t db_data_len,
                                    const uint8_t *seed,
                                    uintptr_t seed_len,
                                    int32_t accounts,
 ...
 */
int32_t piratelc_scan_blocks(const uint8_t *db_cache,
 ...
 */
int32_t piratelc_validate_combined_chain(const uint8_t *db_cache,
                                         uintptr_t db_cache_len,
                                         const uint8_t *db_data,
                                         uintptr_t db_data_len,
                                         uint32_t network_id);
 ...
 */
void piratelc_vec_string_free(char **v, uintptr_t len, uintptr_t capacity);
